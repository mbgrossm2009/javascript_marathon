...
In `shipyard.js`, first create an array named `
`, and fill it with the name of all your friends!
...
Return an array of trained crew member objects by using both the `` array and the `trainCrew` function.
